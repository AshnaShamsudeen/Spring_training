...
//	
	...
	@ExceptionHandler(ItemNotFoundException.class)
	@ResponseStatus(code=HttpStatus.NOT_FOUND)
	public ErrorResponse handlecustomernotfoundexception(ItemNotFoundException ex,HttpServletRequest request) {
	...
	@ExceptionHandler(InvalidCategoryException.class)
	@ResponseStatus(code=HttpStatus.NOT_FOUND)
	public ErrorResponse handlecustomernotfoundexception(InvalidCategoryException ex,HttpServletRequest request) {
	var status=HttpStatus.NOT_FOUND;
	var StatusValue=status.value();
	var error=status.name();
	var timestamp=LocalDateTime.now();
